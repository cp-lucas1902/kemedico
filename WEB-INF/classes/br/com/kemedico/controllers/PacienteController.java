...
public class PacienteController {
	...
	public ModelAndView atualizaPaciente(@ModelAttribute("pac")Paciente pac) {
		...
		pac.setSenha(pacientedao.getById(pac.getId()).getSenha());
		pacientedao.update(pac);
		view.addObject("mensagem", new Mensagem("Conta atualizada com sucesso", Tipo.SUCESSO));
		view.setViewName("forward:/minhaconta/");
		return view;
	}
